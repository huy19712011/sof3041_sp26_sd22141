package org.example.sof3041_sp26_sd22141.service;

import org.example.sof3041_sp26_sd22141.entity.Student;
...
class StudentServiceTest {
    ...
    void addStudentWithInvalidMark() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                studentService.addStudent(new Student(1, "A", 20, 11.0)));
    ...
    void updateStudentWithInvalidAge(){
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () ->
                studentService.updateStudent(new Student(1, "A", 17, 9.0)));
        assertEquals("Age must be greater than 18", exception.getMessage());
    }
